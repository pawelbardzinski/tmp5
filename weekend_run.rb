...
@currencies = ["AED","ARS","AUD","BHD","BRL","CAD","CHF","CNY","COP","CZK","DJF","DZD","EGP","EUR","GBP","HKD","IDR","INR","IQD","JOD","JPY","KWD","LBP","LYD","MAD","MRO","MXN","MYR","NZD","OMR","PEN","PHP","PLN","QAR","RUR","SAR","SDG","SEK","SGD","SOS","SYP","TND","TRY","USD","VUV","YER","ZAR",'gldslv','gldplt','gldpld']
...
File.open('/tmp5/data3.csv','w') do |f|
  @currencies.each do |currency|
    f.puts currency
    @time.each do |t|
      f.puts t+','+@stuff[currency][t].to_s
    end
  end
end